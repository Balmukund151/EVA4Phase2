...
$.ajax({
	...
	crossDomain: true,
	method: 'POST',
	url: 'https://xxxxxxxx.execute-api.ap-south-1.amazonaws.com/dev/classify',
	data: formData,
	processData: false,
	contentType: false,
...
$.ajax({
	...
	crossDomain: true,
	method: 'POST',
	url: 'https://xxxxxxxx.execute-api.ap-south-1.amazonaws.com/dev/align',
	data: formData,
	processData: false,
	contentType: false,
	mimeType: "multipart/form-data",
...
$.ajax({
	...
	crossDomain: true,
	method: 'POST',
	url: 'https://xxxxxxxx.execute-api.ap-south-1.amazonaws.com/dev/swap_face',
	data: formData,
	processData: false,
	contentType: false,
	mimeType: "multipart/form-data",
...
function uploadAndIdentifyFace() {
var fileInput = document.getElementById('faceIdentifyFileUpload').files;
if(!fileInput.length) {
	return alert("Please choose a file to upload first.");
}
var file=fileInput[0];
...
.done(function (response) {
	console.log(response);
	document.getElementById('faceIdentifyResult').textContent = response;
})
.fail(function(){
	alert("There was an error while sending prediction request to MTCNN model.");
});
};
...
$('#btnfaceIdentifyUpload').click(uploadAndIdentifyFace);
